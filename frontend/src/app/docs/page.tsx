          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
            ...
            <ol className="space-y-3 text-gray-300">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span>Receive wrapped Bitcoin tokens on Ethereum</span>
              </li>
            </ol>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              ...
              <p className="text-gray-300 text-sm">
                Yes, you can burn wrapped Bitcoin tokens to receive Bitcoin back. The process is similar 
      ...
      content: (
        <div className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="border border-gray-700 rounded-lg p-4">
              <h4 className="text-white font-semibold mb-2">Wrapped Bitcoin</h4>
              <p className="text-gray-300 text-sm">
                ERC-20 token on Ethereum that represents Bitcoin. 1 WBTC = 1 BTC.
              </p>
            </div>
